    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6">Artikel</h1>

          <p className="text-red-100/90 text-lg leading-relaxed">
            Informasi, wawasan, dan update terbaru seputar konstruksi, proyek,
            serta aktivitas Berkah Angsana.
          </p>
        </div>
      </div>
    </section>
